...
interface MembershipInformationEmailProps {
  steps?: {
    id: number;
...
const PropDefaults: MembershipInformationEmailProps = {
  steps: [
    {
      id: 1,
      Description: (
...
export const MembershipInformationEmail = ({
  steps = PropDefaults.steps,
  links = PropDefaults.links,
}: MembershipInformationEmailProps) => {
  return (
    <Html>
      <Head />
...
export default MembershipInformationEmail;
